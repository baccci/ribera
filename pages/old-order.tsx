...
import Logo from '@/pagesComponents/Logo'
import Button from '@/pagesComponents/Button'
import XButton from '@/pagesComponents/XButton'
...
const Order = () => {
  const { orderContent, totalPrice, orderType, orderStatus, table } = useShop(
    (state: any) => state
  )
  const { clearCart } = useCart((state: CartState) => state)
  const [orderState, setOrderStatus] = useState<string>('success')
        ...
        <div className={styles.modalWrapper} onClick={handleModalClick}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <table className={styles.ticketTable}>
              ...
              <tbody>
                {orderContent.map(
                  ({ quantity, name, cost, description }: any) => (
            ...
            <div className={styles.buttonWrapper}>
              <Button func={() => handleTicketButtonClick()} loading={loading}>
                Descargar Ticket
              </Button>
            </div>
          </div>
